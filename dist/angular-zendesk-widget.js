    ...
    .provider('ZendeskWidget', [function() {
      ...
      this.$get = [
        ...
        function($window) {
          ...
          ZendeskWidgetApi.prototype.loadWidget = function() {
            ...
            }("https://assets.zendesk.com/embeddable_framework/main.js", settings.accountUrl);

            /*eslint-enable */
            $window.zE(function() {
              settings.beforePageLoad($window.zE);
            });
          }
